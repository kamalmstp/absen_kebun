...
<html lang="en">
  <head>
    ...
    <title>Verdok UP Sungai Putting</title>
                ...
                <div class="block-content block-content-full bg-body-extra-light">
                  ...
                  <div>
                    <table>
                        ...
                        <tr>
                            <td>Penandatangan</td>
                            <td>{{$data->penandatangan." (".$data->jabatan.")"}}</td>
                        </tr>
                        <tr>
                            <td>Mengetahui</td>
                            <td>{{$data->mengetahui." (".$data->jabatan_mengetahui.")"}}</td>
                        </tr>
                    </table>
                  </div>
                  <hr>
                  <div class="text-center">
                    <a href="{{route('dokumen.download', $data->file)}}" type="button" class="btn btn-success"><i class="fa fa-download"></i> Dokumen</a>
                  </div>
                </div>
