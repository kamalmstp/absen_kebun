...
<div class="content">
    <div class="block block-rounded">
        ...
        <h3 class="block-title">QR Code Surat</h3>
                ...
                @foreach($cert as $row)
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a href="javascript:;" onclick="confirmRemove('administration/surat/remove', '{{ $row->id }}')"><i class='fa fa-trash'><u>Remove</u></i></a>
                            @endif
                        </td>
                        <td align="center">
                            ...
                            onclick="confirmDelete('administration/surat', '{{ $row->id }}')">
            ...
            <div class="block-content">
                <div class="row">
                    <div class="text-center">
                        ...
                        <a trpe="button" class="btn btn-sm btn-alt-success" href="{{route('suratqr.download', $rom->qrcode)}}"> <i class="fa fa-download"></i> Download</a> 
                        <br>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="edit{{$rom->id}}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog modal-dialog-popout modal-md" role="document">
      <div class="modal-content">
        <form action="{{route('surat.update', $rom->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-primary-dark">
